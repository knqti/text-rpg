...
armors_2_dict = {
    'straitjacket': {'defense': 5, 'attack': -2, 'damage': 0, 'slot': 'torso', 'type': 'equip', 'description': 'extremely snug'},
    'leather pants': {'defense': 2, 'attack': 0, 'damage': 0, 'slot': 'legs', 'type': 'equip', 'description': 'makes your butt look big'},
    'shield': {'defense': 3, 'attack': 0, 'damage': 0, 'slot': 'hand_2', 'type': 'equip', 'description': 'wuss'}
}